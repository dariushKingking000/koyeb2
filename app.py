...
# Helper to build direct-download URL for Google Drive file id
...
PACKS = {
    "face_pack": {
        ...
        "type": "image",
        "demo_url": gdrive_uc_url("1Z1pJljlqiSwv50gzfMMObm6O9sEdnvf-"),
    ...
    "love_pack": {
        ...
        "type": "image",
        "demo_url": gdrive_uc_url("1nKiuDFLIV2eH9I1bvFsM7I-m8aQlVS8b"),
    ...
    "planets_pack": {
        ...
        "type": "image",
        "demo_url": gdrive_uc_url("18V8UEIg4CZ-ZOh60OzL464a_ejJu9O15"),
    ...
    "video1": {
        ...
        "type": "video",
        "demo_url": gdrive_uc_url("1AnC8oa0yagOsSLQzKMj6F6dI9F-vVjAm"),
    ...
    "video2": {
        ...
        "type": "video",
        "demo_url": gdrive_uc_url("1A6iepbWwsgO0j5dcJXjyaAzuHV0pbBcZ"),
    ...
    "video3": {
        ...
        "type": "video",
        "demo_url": gdrive_uc_url("1NcXQG8QaMmiFmHKYtqcVAmBvWN-NWOBJ"),
...
DEMO_POOL = [
    ...
    gdrive_uc_url("1K8rYumafJFPnTGU9JlwWY_udjWBYNDe0"),
    gdrive_uc_url("1lEQI46H_RsXNPj3lrLFrruRbSfWAI3nk"),
    gdrive_uc_url("1ViTDUK9Hj-e3r4g0sW-LB3rX0N3fDq0N"),
    gdrive_uc_url("1b7BMbcDF3m_EpXohO-egYqNXzx21AI7G"),
    gdrive_uc_url("1-gdYEM-Rs2I7WpXXGFCzlxldIKcY49J6"),
    gdrive_uc_url("1cpA9pDIBpXCYC1lWha63q8x0VaPGSs6M"),
    gdrive_uc_url("1b9p1TPrRwLHFJV42_FcEfFoke_aClomH"),
]
...
def user_can_request_demo(user_id):
    ...
    if elapsed >= DEMO_COOLDOWN_SECONDS:
        return True, 0
    return False, int(DEMO_COOLDOWN_SECONDS - elapsed)


def record_demo_usage(user_id):
    DEMO_USAGE[int(user_id)] = int(time.time())
        ...
        if "callback_query" in update:
            ...
            if data == "demo":
                ...
                if not allowed:
                    ...
                    if hours >= 1:
                        send_message(chat_id, f"You've recently used Demo. Please try again in {hours} hour(s) and {mins} minute(s).")
                    else:
                        send_message(chat_id, f"You've recently used Demo. Please try again in {mins} minute(s).")
                    return
