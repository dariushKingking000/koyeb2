...
# ---------- Configuration ----------
BOT_TOKEN = os.getenv("BOT_TOKEN")   # 👈 فقط همین
...
def pack_actions(pack_id):
    return {
        "inline_keyboard": [
            [{"text": "📤 Demo", "callback_data": f"demo:{pack_id}"}],
...
def webhook():
    ...
    if "callback_query" in update:
        ...
        if data == "images":
            ...
            send_message(chat_id, "Demo AI Store Bot 🤖")
        elif data == "back":
            ...
            pid = data.split(":")[1]
            send_photo(chat_id, PACKS[pid]["demo_url"], "Demo preview")
